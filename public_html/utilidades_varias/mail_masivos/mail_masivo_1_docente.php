...
function CONFIRMAR()
{
	c=confirm('Seguro(a) Desea Enviar Email a los Docentes\n a continuacion los debe seleccionar..?');
...
<div id="Layer1">
<form action="mail_masivo_2_docente.php" method="post" enctype="multipart/form-data" name="frm" id="frm">
  <table width="50%" border="1" align="center">
  <caption></caption>
  <thead>
    <tr>
      <th colspan="3"><span class="Estilo1">Busqueda de Docentes 
    ...
    <tr class="odd">
      ...
      <td width="171" colspan="2"><?php
	  include("../../../funciones/funcion.php");
	  echo selector_sede(); 
	  ?></td>
    </tr>
    <tr class="odd">
      <td>con asignaciones</td>
      <td colspan="2"><select name="con_asignaciones" id="con_asignaciones">
        <option value="solo_actuales" selected="selected">solo_actuales</option>
        <option value="con_acceso" selected="selected">con_acceso</option>
        <option value="todos">todos</option>
      </select></td>
    </tr>
    <tr class="odd">
      <td>Periodo Asignaciones</td>
      <td><?php echo CAMPO_SELECCION("semestre_A","semestre",$semestre_actual,false);?> (semestre)</td>
      <td><?php echo CAMPO_SELECCION("year_A","year",$year_actual,false);?> (year)</td>
      </tr>
    </tbody>
	<tfoot>
	  <tr>
