...
function CONFIRMAR()
{
	c=confirm('Seguro(a) Desea Enviar Email a Administrativos\n a continuacion los debe seleccionar..?');
...
<div id="Layer1">
<form action="mail_masivo_2_administrativo.php" method="post" enctype="multipart/form-data" name="frm" id="frm">
  <table width="50%" border="1" align="center">
  <caption></caption>
  <thead>
    <tr>
      <th colspan="6"><span class="Estilo1">Busqueda de Administrativos 
    ...
    <tr class="odd">
      ...
      <td width="171" colspan="5"><?php
		...
		echo CAMPO_SELECCION("sede","sede",$sede_usuario,true);
	  ?></td>
    </tr>
    <tr class="odd">
      <td>&nbsp;</td>
