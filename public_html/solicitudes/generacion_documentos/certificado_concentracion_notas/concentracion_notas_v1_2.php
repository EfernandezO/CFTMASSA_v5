...
////////////////////
		...
		if($mostrarHoja2){
			...
			$pdf->SetFont('Arial','',12);
			//parrafo 1
			$pdf->MultiCell(195,6,utf8_decode($parrafo_12),$borde,"J");
			$pdf->ln();
			////
		 ...
		 $cod_proceso_practica=NULL;
			...
			$pdf->MultiCell(195,6,utf8_decode($parrafo_13),$borde,"J");
			$pdf->ln();
