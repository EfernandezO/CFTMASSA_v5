...
if($tipoUsuario=="funcionario"){
	$array_firmas=array(417, 411); 
	$urlVolver="../../../buscador_alumno_BETA/HALL/index.php";}
else{
	$array_firmas=array(446);
...
if($hay_solicitud)
{
	...
	$sql_c->free();	
		...
		{
			$action="";
			$url="titulo_en_tramite_v1_2.php?id_solicitud=$id_solicitud";
			if(DEBUG){ echo"URL: $url";}
			else{ header("location: $url");}
		}
		else
		{$action="titulo_en_tramite_v1_2.php";}
}
else
...
<title>Confirmacion - CertificadoTitulo en Tramite</title>
