...
if($_POST)
{
	...
	$id_docente_evaluar=mysqli_real_escape_string($conexion_mysqli, $_POST["id_docente"]);
	$continuar=true;
}
else
{
...
<div id="link"><br><a href="resultados_evaluacion_docente.php" class="button">Volver a Seleccion</a></div>
<div id="apDiv2">
<?php
if($continuar)
{
