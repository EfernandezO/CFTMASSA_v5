...
{//var_export($_SESSION["FINANZAS"]);
	...
	if(isset($_SESSION["FINANZAS"]["beneficiosEstudiantiles"])){
	 foreach($_SESSION["FINANZAS"]["beneficiosEstudiantiles"] as $auxIdBeneficio =>$arrayValores){
		...
		$totalBeneficiosEstudiantiles+=$totalizadoBeneficio;
	 }
	}
	//grabo en la sesion
	$_SESSION["FINANZAS"]["totalBeneficiosEstudiantiles"]=$totalBeneficiosEstudiantiles;
	...
	/////////////////////calculo descuento
	$total=(($arancel-$totalBeneficiosEstudiantiles)-$saldo_a_favor);
...
<h1 id="banner">Contrato - Paso 3c/3</h1>
<div id="apDiv1">
  <table width="100%" border="0">
  <thead>
    <tr>
      <th colspan="2" bgcolor="#e5e5e5"><strong>Informaci&oacute;n</strong></th>
    </tr>
    </thead>
    <tr>
    ...
    <tr>
      ...
      <td><input name="cantidad_beca" type="text" id="cantidad_beca" value="<?php echo $totalBeneficiosEstudiantiles;?>"  readonly="readonly"/></td>
    </tr>
    <tr>
      <td>Total</td>
...
<div id="apDiv3">
<form action="paso_3c_X.php" method="post" name="frm" id="frm">
  <div id="TabbedPanels1" class="TabbedPanels">
    ...
    <div class="TabbedPanelsContentGroup">
      <div class="TabbedPanelsContent">
        ...
        <thead>
          <tr>
            <th colspan="4"><input name="validador" type="hidden" id="validador" value="<?php echo md5("PASO3".date("Y-m-d"));?>" />
              <strong>Linea Credito</strong></th>
          </tr>
          </thead>
          <tr>
      ...
      <div class="TabbedPanelsContent">
        ...
        <thead>
          <tr>
            <th colspan="2"><strong>Efectivo</strong></th>
          </tr>
          </thead>
          <tr>
