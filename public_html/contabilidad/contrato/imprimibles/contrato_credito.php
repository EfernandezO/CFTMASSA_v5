...
//////////////
	...
	//Cita en itálica
   // $this->SetFont('','I');
 //   $this->MultiCell(48,5,'_______________________ Alumno',0,'C');
//$this->SetFont('','I');
//	$this->SetXY($aux_X+50, $aux_Y);
  //  $this->MultiCell(48,5,'_______________________ CFT Massachusetts LTDA',0,'C');
$pdf->PrintChapter(2,$ultimo_parrafo,'');
///////FIRMAS
...
$aux_Y=$pdf->GetY();
$pdf->SetFont('','I');
$pdf->MultiCell(40,5,'_______________________ Alumno',0,'C');
$pdf->SetXY($aux_X+70, $aux_Y);
$pdf->MultiCell(40,5,'_______________________ CFT Massachusetts LTDA',0,'C');
$pdf->Output();
?>