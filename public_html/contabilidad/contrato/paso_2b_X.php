...
if($_POST)
{
	...
	$comentario_beca="";
	///*****///
	$beca_nuevo_milenio=0;
	$aporte_beca_nuevo_milenio=0;
	
	$beca_excelencia_academica=0;
	...
	{
		if(isset($_SESSION["FINANZAS"]["comentario_beca"], $_SESSION["FINANZAS"]["cantidad_beca"]))
		{
			unset($_SESSION["FINANZAS"]["comentario_beca"]);
			$_SESSION["FINANZAS"]["cantidad_beca"]=0;
		}
	}
	//var_export($_SESSION["FINANZAS"]["cantidad_beca"]);
	//fin becas
