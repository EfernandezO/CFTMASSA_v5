	...
	require("../../../funciones/funcion.php");
		...
		switch($tipo_alumnos)
		{
			case"todos":
				...
				break;
			case"nuevos":
				$cons_1="SELECT contratos2.*,MONTH( contratos2.fecha_generacion) AS mes, contratos2.yearIngresoCarrera FROM contratos2 INNER JOIN alumno ON contratos2.id_alumno=alumno.id WHERE MONTH(fecha_generacion)='$mes_consulta' AND ano='$year_consulta_1' AND contratos2.yearIngresoCarrera='$year_consulta_1' ORDER by sede, ano, fecha_generacion";
				$tipo_alumnos_label="los nuevos alumnos";

				$cons_1_full="SELECT contratos2.id, contratos2.sede FROM contratos2 INNER JOIN alumno ON contratos2.id_alumno=alumno.id WHERE ano='$year_consulta_1' AND contratos2.yearIngresoCarrera='$year_consulta_1' AND fecha_generacion<'$fecha_corte'ORDER by contratos2.sede, ano, fecha_generacion";
				break;
		}
		////////////////////////////////////////////
		...
		switch($tipo_alumnos)
		{
			case"todos":
				...
				break;
			case"nuevos":
				$cons_2="SELECT contratos2.*,MONTH( contratos2.fecha_generacion) AS mes, alumno.ingreso FROM contratos2 INNER JOIN alumno ON contratos2.id_alumno=alumno.id WHERE MONTH(fecha_generacion)=$mes_consulta AND ano='$year_consulta_2' AND contratos2.yearIngresoCarrera='$year_consulta_2' ORDER by sede, ano, fecha_generacion";
				
			
				$cons_2_full="SELECT contratos2.id, contratos2.sede FROM contratos2 INNER JOIN alumno ON contratos2.id_alumno=alumno.id WHERE ano='$year_consulta_2' AND contratos2.yearIngresoCarrera='$year_consulta_2' AND fecha_generacion<'$fecha_corte'ORDER by contratos2.sede, ano, fecha_generacion";
				break;
		}
