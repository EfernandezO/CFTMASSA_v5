...
<body>
<h1 id="banner">Administrador - Envio Boletin Informativo <?php echo date("d/m/Y H:i:s");?></h1>
<div id="link"><br />
...
<?php
	...
	$deuda_actual_alumno=($A_deuda_actual +$A_intereses+$A_gastos_cobranza);
							...
							$valores="'$id_alumno', '$A_id_carrera', '$A_sede', 'email', '$fecha_hora_actual', 'envio boletin informativo automatico', '$deuda_actual_alumno', '$Cx_year', '$id_usuario_actual'";
							...
							else
							{
								...
								{ 
									$error="C1";
									//--------------------------------------------//
									$evento="Realiza Cobranza (email) a Alumno id_alumno: $id_alumno Por deuda: $deuda_actual_alumno";
									REGISTRA_EVENTO($evento);
									REGISTRO_EVENTO_ALUMNO($id_alumno, "cobranza", "Realizacion de Cobranza (email) por deuda actual de: $deuda_actual_alumno");
									//-----------------------------------------////
								}
							}
						}
