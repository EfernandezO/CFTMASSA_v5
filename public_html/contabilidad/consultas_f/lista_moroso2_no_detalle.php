	...
	if($_POST)
	{
		...
		//echo"numero de alumnos $numero_filas<br>";
			...
			echo'
				...
				<tr>
				<td colspan="5" bgcolor="#99FF00"><div align="center" class="Estilo1 Estilo3">Detalle Alumnos Morosos - '.$fcarrera.' - Nivel '.$fnivel.' - Jornada '.$fjornada.'</div></td>
				</tr>
  				<tr>
			...
			<td width="230" bgcolor="#66CCFF"><div align="center"><strong>Total</strong></div></td>
  				</tr>';
				...
				if($Deuda!=NULL)
				{
					...
					if(($escritos>0)and($escritos%$salto_cada==0))
					{
						echo'<tr bgcolor="#66CCFF" >
						  ...
						  <td width="232"><div align="center"><strong>Total</strong></div></td>
						</tr>';
					}
    				...
    				<td  valign="top" aling="center"> $ '.$total_deu.'</td>';
