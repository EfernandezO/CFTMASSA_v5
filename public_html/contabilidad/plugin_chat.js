...
*/
var url_absoluta="../chat/chat.php";
...
function chatHeartbeat(){
	...
	$.ajax({
	  url: url_absoluta+"?action=chatheartbeat",
	  cache: false,
	  dataType: "json",
...
function closeChatBox(chatboxtitle) {
	...
	$.post(url_absoluta+"?action=closechat", { chatbox: chatboxtitle} , function(data){	
	});
...
function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle) {
	...
	if(event.keyCode == 13 && event.shiftKey == 0)  {
		...
		if (message != '') {
			$.post(url_absoluta+"?action=sendchat", {to: chatboxtitle, message: message} , function(data){
...
function startChatSession(){  
	$.ajax({
	  url: url_absoluta+"?action=startchatsession",
	  cache: false,
	  dataType: "json",
	  success: function(data) {
