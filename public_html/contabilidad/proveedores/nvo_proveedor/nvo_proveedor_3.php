...
if($_GET)
{
	...
	{
		case"0":
			$msj="Proveedor Agregado Exitosamente";
			$img=$img_ok;
			break;
		case"1":
			$msj="Fallo al Agregar proveedor";
			$img=$img_error;
			break;	
		case"2":
			$msj="El Proveedor que intenta ingresar ya existe en el sistema";
			$img=$img_error;
			break;	
		case"3":
			$msj="Datos de Proveedor incorrectos, verifique y vuelva a intentar";
			$img=$img_error;
			break;	
		case"4":
			$msj="No se puede continuar rut con problemas";
			$img=$img_error;
			break;		
