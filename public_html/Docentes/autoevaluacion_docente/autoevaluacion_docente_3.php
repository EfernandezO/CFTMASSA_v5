...
{	
				...
				switch($aux_tipo_pregunta)
				{
					case"alternativa":
						...
						if(isset($ARRAY_RESPUESTA_ANEXA[$aux_respuesta]))
						{
							...
							$campos="id_usuario, tipo_usuario, id_usuario_evaluar, semestre_evaluar, year_evaluar, sede_evaluar, fecha_generacion, id_encuesta, id_pregunta, id_alternativa, respuesta_directa";
							$valores="'$id_usuario_encuesta', '$tipo_usuario_encuesta', '$id_usuario_evaluar', '$semestre_evaluar', '$year_evaluar', '$sede_usuario', '$fecha_hora_actual', '$id_encuesta', '$aux_id_pregunta', '$aux_respuesta', '$aux_respuesta_anexa'";
						}
						else{
							if(DEBUG){ echo"NO hay respuesta Anexa<br>";}
							$campos="id_usuario, tipo_usuario, id_usuario_evaluar, semestre_evaluar, year_evaluar, sede_evaluar, fecha_generacion, id_encuesta, id_pregunta, id_alternativa";
							$valores="'$id_usuario_encuesta', '$tipo_usuario_encuesta', '$id_usuario_evaluar', '$semestre_evaluar', '$year_evaluar',  '$sede_usuario', '$fecha_hora_actual', '$id_encuesta', '$aux_id_pregunta', '$aux_respuesta'";	
							}
					...
					case"directa":
						$guardar=true;
						$campos="id_usuario, tipo_usuario, id_usuario_evaluar, semestre_evaluar, year_evaluar, sede_evaluar, fecha_generacion, id_encuesta, id_pregunta, respuesta_directa";
						$valores="'$id_usuario_encuesta', '$tipo_usuario_encuesta', '$id_usuario_evaluar', '$semestre_evaluar', '$year_evaluar', '$sede_usuario', '$fecha_hora_actual', '$id_encuesta', '$aux_id_pregunta', '$aux_respuesta'";
						break;
					default:
						$guardar=false;	
	...
	$url="autoevaluacion_docente_4.php?error=C0";
