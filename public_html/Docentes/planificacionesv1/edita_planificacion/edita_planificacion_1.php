...
if(DEBUG){var_dump($_POST);}
	...
	$sqli=$conexion_mysqli->query($cons);
		...
		$id_usuario=$P["id_funcionario"];
		$id_carrera=$P["id_carrera"];
		$cod_asignatura=$P["cod_asignatura"];
		$jornada=$P["jornada"];
		$grupo_curso=$P["grupo"];
		$semestre=$P["semestre"];
		$year=$P["year"];
...
<body onload="xajax_COMPRUEBA(<?php echo $numero_semana;?>, document.getElementById('id_carrera').value, document.getElementById('cod_asignatura').value, document.getElementById('semestre').value, document.getElementById('year').value, document.getElementById('sede').value, document.getElementById('jornada').value, document.getElementById('grupo_curso').value, document.getElementById('id_programa').value, <?php echo $id_planificacion;?>); return false;">
...
<div id="apDiv2">
<form action="../../contenidos/edita/edita_planificacion_2.php" method="post" id="frm">
  <table width="100%" border="1">
  <thead>
    <tr>
