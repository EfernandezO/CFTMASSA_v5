...
<title>Asignacion Automatica - Adm. Asignatura</title>
...
{
	case"ADA0":
		$msj="La asignacion Automatica se realizo con Exito";
		$img=$img_ok;
		break;
	case"ADA1":
		$msj="No ha Seleccionado ningun docente para el proceso masivo";
		$img=$img_ok;
		break;
	case"ADA2":
		$msj="Ha ocurrido un error al registrar una asignacion... verificar";
		$img=$img_error;
		break;
	case"ADA3":
		$msj="Sin Datos";
...
?>
<body>
<h1 id="banner">Administrador - Asignacion automatica Adm. Asignatura</h1>
<div id="apDiv1">
