...
<title>Elimina Registro Asistencia</title>
...
switch($error)
{
	...
	case"EA0":
		$msj="Registro de Asistencia Eliminada Exitosamente";
		$img=$img_ok;
		break;
	case"EA1":
		$msj="Error, al Eliminar registro de Asistencia";
		$img=$img_error;
	default:
		$msj="";
		$img="";	
...
?>
<body>
<h1 id="banner">Administrador - Elimina Registro Asistencia</h1>
<div id="apDiv1">
