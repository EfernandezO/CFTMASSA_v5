...
$xajax = new xajax("../../buscador_alumno_BETA/buscador_server.php");
...
<form action="enrutador.php" method="post" name="frm" id="frm" onkeypress = "return pulsar(event)">
  <table width="100%" border="0" align="left">
  	<thead>
    <tr>
      <th colspan="3"><strong>Busqueda de Alumnos</strong></th>
      </tr>
      </thead>
      <tbody>
    <tr>
    ...
    <tr>
      <td colspan="2" class="Estilo4">A&ntilde;o Ingreso</td>
      <td class="Estilo4" >Situaci&oacute;n</td>
    </tr>
    <tr>
