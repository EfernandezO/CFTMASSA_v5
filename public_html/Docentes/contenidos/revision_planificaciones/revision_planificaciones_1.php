...
<body onload="xajax_BUSCA_PLANIFICACIONES(document.getElementById('fsede').value, document.getElementById('year').value, document.getElementById('semestre').value); return false;">
<h1 id="banner">Administrador - Revision Planificaciones</h1>
<div id="link"><br />
  <div id="div_superior"></div>
  <a href="../../lista_funcionarios.php" class="button">Volver</a>
</div>
...
<div id="apDiv2">
  ...
  <thead>
    ...
    <tr>
      <td>A&ntilde;o</td>
      <td><select name="year" id="year" onchange="xajax_BUSCA_PLANIFICACIONES(document.getElementById('fsede').value, document.getElementById('year').value, document.getElementById('semestre').value); return false;">
        <?php
	  	$anos_anteriores=10;
		$anos_siguientes=1;
    ...
    <tr>
      <td>Semestre</td>
      <td> <select name="semestre" id="semestre" onchange="xajax_BUSCA_PLANIFICACIONES(document.getElementById('fsede').value, document.getElementById('year').value, document.getElementById('semestre').value); return false;">
