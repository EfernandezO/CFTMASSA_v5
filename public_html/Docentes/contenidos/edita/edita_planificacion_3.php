...
function CERRAR()
{
	url="../ver_planificaciones.php?id_planificacionMain=<?php echo $id_planificacionMain;?>&error=$error";
	//alert(url);
...
{
	case"PE0":
		$msj="Planificacion Modificada Exitosamente";
		$img=$img_ok;
		break;
	case"PE1":
		$msj="Fallo al intentar Modificar Planificacion";
		$img=$img_error;
		break;
	default:
		$msj="";
