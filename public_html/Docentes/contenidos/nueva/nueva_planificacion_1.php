...
<div id="link"><br />
<a href="../../planificaciones - Copia/nueva_planificacion/nueva_planificacion_1.php?id_carrera=<?php echo $id_carrera;?>&amp;asignatura=<?php echo $cod_asignatura;?>&amp;semestre=<?php echo $semestre;?>&amp;year=<?php echo $year;?>&amp;sede=<?php echo $sede;?>&amp;jornada=<?php echo $jornada;?>&amp;grupo=<?php echo $grupo_curso;?>" class="button">Volver</a></div>
<div id="apDiv1">
...
<div id="apDiv2">
<form action="../../planificaciones - Copia/nueva_planificacion/nueva_planificacion_2.php" method="post" id="frm">
  <table width="100%" border="1">
  <thead>
    <tr>
