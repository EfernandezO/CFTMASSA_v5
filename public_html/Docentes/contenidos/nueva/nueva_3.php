...
//-----------------------------------------//
$id_contenidoMain=$_GET["id_contenidoMain"];
$error=$_GET["error"];
?>
...
function CERRAR()
{
	...
	window.parent.document.location="../ver_contenidos.php?id_contenidoMain=<?php echo base64_encode($id_contenidoMain);?>";
}
...
{
	case"PI0":
		$msj="Contenido Agregada Exitosamente";
		$img=$img_ok;
		break;
	case"PI1":
		$msj="Fallo al intentar Agregar Contenido";
		$img=$img_error;
		break;
	default:
		$msj="";
...
?>
<body>
<h1 id="banner">Administrador -  Nuevo Contenido V 0.5</h1>
<div id="apDiv1">
