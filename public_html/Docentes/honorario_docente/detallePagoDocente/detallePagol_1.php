...
<div id="apDiv1">
  <form action="detallePago2_2.php" method="post" id="frm">
    <table width="40%" border="1" align="center">
      ...
      <tbody>
        <tr>
          <td>Sede</td>
          <td colspan="2"><?php include("../../../../funciones/funcion.php"); echo selector_sede("fsede","",true);?></td>
        </tr>
        <tr>
          <td>A&ntilde;o</td>
	  ...
	  ?>
        ...
        <tr>
          <td colspan="3"><div id="apDiv2">
            <div id="div_x"><a href="#" class="button_G" onclick="VERIFICAR();">Revisar</a></div>
          </div>
            ...</td>
        </tr>
      </tbody>
