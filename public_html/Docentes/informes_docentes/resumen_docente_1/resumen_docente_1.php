...
<body>
<h1 id="banner">Administrador - Informe Docente Asignaciones, titulo y antiguedad</h1>
<div id="link"><br />
<a href="../../lista_funcionarios.php" class="button">Volver al Menu</a></div>
<div id="apDiv1">
<form action="resumen_docente_2.php" method="post" id="frm" >
