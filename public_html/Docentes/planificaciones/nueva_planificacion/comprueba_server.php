...
function COMPRUEBA($num_semana, $id_planificacionMain)
{
	...
	$div='div_info';
		...
		$cons_HS="SELECT SUM(horas_semana) FROM planificaciones WHERE idPlanificacionMain='$id_planificacionMain' AND numero_semana='$num_semana'";
