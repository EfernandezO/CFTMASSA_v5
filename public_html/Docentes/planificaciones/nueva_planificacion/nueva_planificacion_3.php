...
//-----------------------------------------//	
$id_planificacionMain=$_GET["id_planificacionMain"];
$error=$_GET["error"];
?>
...
function CERRAR()
{
	...
	window.parent.document.location="../ver_planificaciones.php?id_planificacionMain=<?php echo base64_encode($id_planificacionMain);?>";
}
...
{
	case"PI0":
		$msj="Planificacion Agregada Exitosamente";
		$img=$img_ok;
		break;
	case"PI1":
		$msj="Fallo al intentar Agregar Planificacion";
		$img=$img_error;
		break;
	default:
		$msj="";
