...
<h1 id="banner">Administrador -  Registro  Planificaciones Academicas V2.0</h1>
<div id="link"><br />
<a href="<?php echo $url_menu;?>" class="button">Volver a Menu</a></div>
<div id="apDiv1">
<form action="ver_planificaciones.php" method="post" id="frm">
...
<div id="apDiv3">Permise acceder al Planificador de los cursos, para los cuales el docente tiene una asignacion previa.</div>
<div id="apDiv2"><a href="#" class="button_G" onclick="VERIFICAR();">Ir a Curso</a></div>
</body>
</html>