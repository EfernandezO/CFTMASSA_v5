...
function COMPRUEBA($num_semana, $id_planificacion, $id_planificacionMain)
{
	...
	$sqliPM->free();	
		...
		$cons_HS="SELECT SUM(horas_semana) FROM planificaciones WHERE idPlanificacionMain='$id_planificacionMain' AND id_planificacion<>'$id_planificacion' AND numero_semana='$num_semana'";
