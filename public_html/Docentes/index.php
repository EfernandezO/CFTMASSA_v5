...
<br></div></div>
	...
	<div id="contenido">
	  <div align="center"> <br>
	    ...
	    <br>
<!--Inicio galeria-->
<img src="../IMG_store/docentes_banner.jpg" alt="Docentes" width="525" height="46" />
<form action="controldocen.php" method="post" enctype="multipart/form-data" name="frm" id="frm">
	...
	if($ver_error){?>
		bgcolor=#FF0000><span style="color:ffffff"><b>Datos incorrectos</b></span>
            <?php }else{?>
          bgcolor=#66ccff>Introduce tu clave de acceso
          <?php }?></td>
      </tr>
      <tr>
        <td width="36%" bgcolor="#E8E8E6">RUT</td>
        <td width="64%" bgcolor="#E8E8E6"><input name="frut" type="text" id="frut" onFocus="MM_showHideLayers('fondo_infod','','show','info_d','','show')" onMouseover="ddrivetip('Ingrese Rut sin Puntos', 150)" onMouseout="hideddrivetip()";>
        </td>
      </tr>
      <tr>
        <td width="36%" bgcolor="#E8E8E6">Clave</td>
        <td width="64%" bgcolor="#E8E8E6"><input name="fclave" type="password" id="fclave" size="10" maxlength="10">
        </td>
      </tr>
      <tr>
        <td colspan="2" bgcolor="#E8E8E6">
          <div align="left">
            <input type="submit" name="Submit" value="Acceder">
            <input type="reset" name="Submit2" value="Borrar">
            <input name="validador" type="hidden" id="validador" value="<?php echo md5("docenteX".date("d-m-Y"));?>" />
          </div></td>
      </tr>
    </table>
  </form>
