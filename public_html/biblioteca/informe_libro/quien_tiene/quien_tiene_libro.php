...
<div id="apDiv1">
<form action="quien_tiene_libro_2.php" method="post" name="frm" id="frm">
  <table width="50%" border="1" align="center">
  <thead>
    <tr>
      <th colspan="2">Seleccine los parametros para iniciar la busqueda de que alumnos Tienen libros Prestados</th>
    </tr>
    </thead>
    <tbody>
    <tr>
