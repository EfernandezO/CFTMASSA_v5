...
<body>
<h1 id="banner">Administrador - Informe comprobar egresados</h1>
<?php
...
<div id="Layer1">
<form action="comprobar_egresado.php" method="post" name="frm" target="_blank" id="frm">
...
<div id="apDiv1">Busca Alumnos que esten  en condicion vigente (V) y deban estan como egresados. <br />
  Los Alumno en situacion (T,E,P,R,EG) son ignorados
</div>
</body>
</html>
