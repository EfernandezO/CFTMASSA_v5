...
$O->clave_del_archivo=md5("Notas_parcialesV3->seleccionAsignatura");
	...
	include("../../../funciones/funciones_sistema.php");
	 ...
	 switch($privilegio)
	 {
		...
		case"Docente":
			...
			break;
			case"jefe_carrera":
			$cons_asignatura="SELECT DISTINCT(cod_asignatura) FROM toma_ramo_docente WHERE  semestre='$semestre' AND year='$year' AND sede='$sede' AND id_carrera='$id_carrera'";
					$sql_asignatura=$conexion_mysqli->query($cons_asignatura);
					$num_asignatura=$sql_asignatura->num_rows;
