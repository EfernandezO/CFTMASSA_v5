...
//--------------CLASS_okalis------------------//
	...
	$O->clave_del_archivo=md5("certificado->informe_general_V1");
...
if($continuar_1)
{
	...
	$evento="Imprime informe General Alumno id_alumno: $id_alumno id_carrera: $id_carrera";
	...
	$pdf->Cell(40,6,ucwords(strtolower($A_fono)),$borde,0,'L');
	$pdf->Cell(25,6,"Email",$borde,0,'L');
	$pdf->Cell(90,6,$A_email,$borde,1,'L');
	//domicilio
...
//-------------------------------------------------------------------------------------------------------------------//
	...
	$cons_N="SELECT * FROM notas WHERE id_alumno='$id_alumno' AND id_carrera='$id_carrera' AND yearIngresoCarrera='$yearIngresoCarrera' order by cod";
