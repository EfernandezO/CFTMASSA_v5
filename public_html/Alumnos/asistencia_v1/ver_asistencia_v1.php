   ...
   { $semeste_actual=2;}
		...
		if($num_periodos>0)
		{
			...
			while($PTR=$sql_TR->fetch_assoc())
			{
				...
				$periodos_con_notas_parciales.=' <button type="button" class="'.$clase_boton.'" onClick="xajax_BUSCAR_ASISTENCIA('.$periodo_semestre.', '.$periodo_year.', '.$id_alumno.', '.$id_carrera.'); return false;">'.$periodo_semestre.' Semestre -'.$periodo_year.'</button>';
				$aux++;
			}
		}
		else
            ...
            <div class="row-fluid">
                  ...
                  <div class="metro-nav-block nav-block-green">
                    ...
                    <div class="metro-nav-block nav-light-purple">
                     ...
                     <div class="metro-nav-block nav-block-grey double" >
                        <a data-original-title="Asistencia" href="ver_asistencia_v1.php">
               ...
               <div class="span12">
                  ...
                  <div class="widget red">
                        <div class="widget-title">
                           <h4><i class="icon-reorder"></i> Periodos Con Asistencia</h4>
                           <span class="tools">
                        ...
                        <div class="widget-body">
                            <p>
                                <?php echo $periodos_con_notas_parciales;?>
                            </p>
                        </div>
                  </div>
               ...
               <!-- BEGIN BASIC PORTLET-->
                ...
                <div class="widget green">
                        <div class="widget-title">
                           <h4><i class="icon-reorder"></i> Detalles de Asistencia</h4>
                           <span class="tools">
                               <a class="icon-chevron-down" href="javascript:;"></a>
                           </span>
                        </div>
                        <div class="widget-body" id="detalle_asistencia">*seleccione revisar para ver el detalle</div>
                  </div> 
