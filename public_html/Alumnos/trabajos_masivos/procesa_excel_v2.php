...
$tabla="<table border=1>
	   ...
	   $tabla.="<td bgcolor='#66CC66'>totalbeneficiosEstudiantiles</td>
				...
				<td bgcolor='#66CC66'>Promedio Nota asignaturas Tomadas(A�o ".YEAR_CONSULTA.")</td>
				
				<td bgcolor='#66CC66'>Promedio Nota asignaturas Tomadas(1 - A�o ".YEAR_CONSULTA.")</td>
				<td bgcolor='#66CC66'>Promedio Nota asignaturas Tomadas(2 - A�o ".YEAR_CONSULTA.")</td>
			</tr>";
if(isset($sheetData))
{
