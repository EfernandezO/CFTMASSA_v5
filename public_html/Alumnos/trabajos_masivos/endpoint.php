...
if ($method == "POST") {
    ...
    if (isset($_GET["done"])) {
        $result = $uploader->combineChunks("../../CONTENEDOR_GLOBAL/trabajos_masivos");
    }
    // Handles upload requests
    else {
        // Call handleUpload() with the name of the folder, relative to PHP's getcwd()
        $result = $uploader->handleUpload("../../CONTENEDOR_GLOBAL/trabajos_masivos");
...
// for delete file requests
    ...
    $result = $uploader->handleDelete("../../CONTENEDOR_GLOBAL/trabajos_masivos");
    echo json_encode($result);
}
else {
