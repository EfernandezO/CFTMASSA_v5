        ...
        <tbody><tr>
		  ...
		  <h1>Nuestra Instituci�n</h1> 
              <ul>
                ...
                <li><a href="../nuestra_institucion/mision_vision.php">Misi�n - Visi�n</a></li>
              </ul>
		  <h2>Sedes</h2>
          <ul>
...
<br></div></div>
	...
	<div id="contenido">
	  <div align="center"> <br>
	    ...
	    <br>
<!--Inicio galeria-->
<img src="../IMG_store/alumnos_banner.jpg" alt="Alumnos" width="525" height="46" />
<form action="controlalumn.php" method="post" enctype="multipart/form-data" name="frm" id="frm"><br />

    <table width="75%" border="0">
      <tr>
        <td colspan="2" align="center" 
	<?php 
		$msj_2='bgcolor="#FF0000"><span style="color:ffffff"><b>Datos incorrectos</b></span>';
        $msj_1='bgcolor="#66ccff">Introduce tu clave de acceso';
		$msj_3='bgcolor="#FFFF00"><span style="color:ffffff"><b>Cuenta Inactiva</b></span>';
		$msj_4='bgcolor="#64B618"><span style="color:ffffff"><b>Sesion Ya Iniciada...</b></span>';
	...
	<tr>
	  <td colspan="2"><input name="validador" type="hidden" id="validador" value="<?php echo md5("alumnoX".date("d-m-Y"));?>" /></td>
	  </tr>
      <tr> 
        <td width="36%" bgcolor="#f5f5f5">RUT</td>
        <td width="64%" bgcolor="#f5f5f5">
          <input name="frut" type="text" id="frut" onFocus="MM_showHideLayers('fondo_info','','show','info_a','','show','btn_cerrar','','show')"  onMouseover="ddrivetip('Ingrese Rut sin Puntos', 150)" onMouseout="hideddrivetip()">        </td>
      </tr>
      <tr> 
        <td width="36%" bgcolor="#f5f5f5">Clave</td>
        <td width="64%" bgcolor="#f5f5f5">
          <input name="fclave" type="password" id="fclave" size="10" maxlength="10">        </td>
      </tr>
      <tr> 
