...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   <meta charset="utf-8">
   <title>Registros Biblioteca</title>
               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li class="active">Libros Pedidos</li>
            ...
            <div class="row-fluid">
                ...
                <div class="metro-nav">
                    <div class="metro-nav-block nav-block-orange double">
                        <a data-original-title="libros" href="registros_biblioteca.php">
                            <i class="icon-book"></i>
                    ...
                    <div class="metro-nav-block nav-block-yellow">
                        <a data-original-title="Notas P" href="notas_parciales_3/ver_notas_parciales_v3_1.php">
                ...
                <div class="widget orange">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>Biblioteca Registros</h4>
                            <span class="tools">
                            ...
                            <div class="widget-body">
                                <table class="table table-striped table-bordered table-advance table-hover">
                                    <thead>
                                    <tr>
                                        <th><i class="icon-bullhorn"></i>Condicion</th>
                                        <th class="hidden-phone"><i class="icon-question-sign"></i>Fecha</th>
                                        <th><i class="icon-bookmark"></i>Libro</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php
									require("../../../funciones/funciones_sistema.php");
                                    $cons_R="SELECT * FROM biblioteca_registro WHERE id_alumno='$id_alumno' ORDER by fecha_registro";
									$sqlR=$conexion_mysqli->query($cons_R)or die($conexion_mysqli->error);
									$num_registros=$sqlR->num_rows;
									if($num_registros>0)		
									{
										while($RB=$sqlR->fetch_assoc())
										{
											$condicion=$RB["condicion"];
											$id_libro=$RB["id_libro"];
											
											
											//nombre del libro
											$consL="SELECT nombre FROM biblioteca WHERE id_libro='$id_libro' LIMIT 1";
											$sqliL=$conexion_mysqli->query($consL)or die($conexion_mysqli->error);
											$L=$sqliL->fetch_assoc();
											$nombre_libro=$L["nombre"];
											$sqliL->free();
											//-/----------------------//
											$fecha_prestamo=$RB["fecha_prestamo"];
											$fecha_devolucion=$RB["fecha_devolucion"];
											
											if($condicion=="prestado"){$clase_x='label-warning'; $fecha_label=$fecha_prestamo;}
											else{$clase_x='label-success'; $fecha_label=$fecha_devolucion;}
											
											
											echo'<tr>
												<td><span class="label '.$clase_x.' label-mini">'.$condicion.'</span></td>
												<td class="hidden-phone">'.$fecha_label.'</td>
												<td>'.$nombre_libro.'</td>
											</tr>';
										}
									}
