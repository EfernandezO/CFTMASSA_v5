...
<title>Proceso de Pendiente</title>
...
if(isset($_GET["error"]))
{
	...
	{
		case"RC0":
			$msj="Proceso de PENDIENTE a Alumno, Exitosamente Creado...";
			$actualizar_sesion=true;
			$img=$img_ok;
			break;
		case"RC1":
			$msj="ERROR al Crear Proceso de PENDIENTE a Alumno";
			$img=$img_error;
			break;	
		case"RA0":
			$msj="Proceso de PENDIENTE a Alumno, Exitosamente Actualizado...";
			$img=$img_ok;
			$actualizar_sesion=true;
			break;
		case"RA1":
			$msj="Error al Actualizar el Proceso de PENDIENTE a Alumno";
			$img=$img_error;
			break;		
...
{$_SESSION["SELECTOR_ALUMNO"]["situacion"]="PENDIENTE";}
?>
<body>
