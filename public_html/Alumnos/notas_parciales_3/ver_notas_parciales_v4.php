...
//-----------------------------------------//	
   ...
   //////////////////////XAJAX/////////////////
	...
	$xajax = new xajax("carga_notas_parciales_v4_server.php");
   ...
   { $semeste_actual=2;}
		...
		if($num_periodos>0)
		{
			...
			while($PTR=$sql_TR->fetch_assoc())
			{
				...
				$periodos_con_notas_parciales.=' <button type="button" class="'.$clase_boton.'" onClick="xajax_BUSCAR_NOTAS_PARCIALES_V4('.$periodo_semestre.', '.$periodo_year.', '.$id_alumno.', '.$id_carrera.'); return false;">'.$periodo_semestre.' Semestre -'.$periodo_year.'</button>';
				$aux++;
			}
		}
		else
               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li class="active">Notas Parciales</li>
               ...
               <div class="span12">
                  ...
                  <div class="widget red">
                        <div class="widget-title">
                           <h4><i class="icon-reorder"></i> Periodos Con Notas</h4>
                           <span class="tools">
