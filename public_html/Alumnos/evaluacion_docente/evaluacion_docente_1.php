...
//-----------------------------------------//	
   ...
   //////////////////////XAJAX/////////////////
	...
	$xajax = new xajax("carga_docentes_server.php");
   ...
   { $semeste_actual=2;}
		...
		if($num_periodos>0)
		{
			...
			while($PTR=$sql_TR->fetch_assoc())
			{
				...
				$periodos_con_notas_parciales.=' <button type="button" class="'.$clase_boton.'" onClick="xajax_BUSCAR_DOCENTES('.$periodo_semestre.', '.$periodo_year.', '.$id_alumno.', '.$id_carrera.'); return false;">'.$periodo_semestre.' Semestre -'.$periodo_year.'</button>';
				$aux++;
			}
		}
		else
		...
		if($hayTomaRamos){$jsTM='onLoad="xajax_BUSCAR_DOCENTES('.$periodo_semestre.', '.$periodo_year.', '.$id_alumno.', '.$id_carrera.');"';}
		$sql_TR->free();
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   <meta charset="utf-8">
   <title>Evaluacion Docente v2</title>
...
<body class="fixed-top" <?php echo $jsTM;?>>
   <!-- BEGIN HEADER -->
               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li class="active">Evaluacion Docente</li>
                  ...
                  <div class="metro-nav-block nav-block-green">
                    ...
                    <div class="metro-nav-block nav-block-grey" >
                     ...
                     <div class="metro-nav-block nav-block-grey double">
                        <a data-original-title="Evaluacion Docente" href="evaluacion_docente_1.php">
