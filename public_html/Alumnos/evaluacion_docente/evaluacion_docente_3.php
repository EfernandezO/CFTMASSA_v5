...
if($continuar)
{
				...
				switch($aux_tipo_pregunta)
				{
					case"alternativa":
						...
						if(isset($ARRAY_RESPUESTA_ANEXA[$aux_respuesta]))
						{
							...
							$valores="'$id_usuario_encuesta', '$tipo_usuario_encuesta', '$id_usuario_evaluar', '$semestre_evaluar', '$year_evaluar', '$sede_alumno', '$id_carrera_evaluar', '$fecha_hora_actual', '$id_encuesta', '$aux_id_pregunta', '$aux_respuesta', '$aux_respuesta_anexa'";
						}
						else{
							...
							$valores="'$id_usuario_encuesta', '$tipo_usuario_encuesta', '$id_usuario_evaluar', '$semestre_evaluar', '$year_evaluar',  '$sede_alumno', '$id_carrera_evaluar', '$fecha_hora_actual', '$id_encuesta', '$aux_id_pregunta', '$aux_respuesta'";	
							}
	...
	$url="evaluacion_docente_4.php?error=C0";
