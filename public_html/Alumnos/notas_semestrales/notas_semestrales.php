...
//-----------------------------------------//	
   ...
   //--------------------------------------------------//
	 ...
	 CAMBIA_ESTADO_CONEXION_ALUMNO($id_alumno, "ON");
	  $evento="Revisa Calificaciones Semestrales";
               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li class="active">Notas Semestrales</li>
            ...
            <div class="row-fluid">
                ...
                <div class="metro-nav">
                    ...
                    <div class="metro-nav-block nav-olive double">
                        <a data-original-title="Notas S" href="notas_semestrales.php">
                            <i class="icon-edit"></i>
                ...
                <div class="span12">
                            ...
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>Notas Semestrales</h4>
                            <span class="tools">
                            ...
                            <div class="widget-body">
                                <table class="table table-striped table-bordered table-advance table-hover">
                                    <thead>
                                    <tr>
                                        <th><i class="icon-bullhorn"></i>Cod</th>
                                        <th class="hidden-phone"><i class="icon-question-sign"></i>Asignatura</th>
                                        <th><i class="icon-bookmark"></i>Nivel</th>
                                         <th><i class="icon-calendar">Periodo</th>
                                        <th><i class=" icon-edit"></i>Notas</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php
									require("../../../funciones/funciones_sistema.php");
                                    $cons_N="SELECT * FROM notas WHERE id_alumno='$id_alumno' AND id_carrera='$id_carrera' AND ramo<>'' order by cod";
									$sqlN=$conexion_mysqli->query($cons_N)or die($conexion_mysqli->error);
									$num_notas=$sqlN->num_rows;
									if($num_notas>0)		
									{
										while($S=$sqlN->fetch_assoc())
										{
											$cod=$S["cod"];
											$ramo=$S["ramo"];
											$nota=$S["nota"];
											...
											if($nota>4){$clase_x='label-success';}
											else{$clase_x='label-warning';}
											
											
											echo'<tr>
												<td>'.$cod.'</td>
												<td class="hidden-phone">'.$ramo.'</td>
												<td>'.$nivel.'</td>
												<td>'.$semestre.'-'.$ano.'</td>
												<td><span class="label '.$clase_x.' label-mini">'.$nota.'</span></td>
											</tr>';
										}
									}
									  else
									  {
										 echo'<tr>
												<td colspan="5">Registro academico No Creado...</td>
											</tr>'; 
									  }
