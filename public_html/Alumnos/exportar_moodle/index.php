...
<title>Exportar a  Moodle</title>
</head>

<body>
<h1 id="banner">Administrador - Exportar a Moodle</h1>
<div id="link"><br />
<a href="../menualumnos.php" class="button">Volver</a></div>
<div id="apDiv1">
<form action="exportar_moodle.php" method="post" enctype="multipart/form-data" id="frm">
