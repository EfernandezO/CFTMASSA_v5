                   ...
                   <ul class="nav pull-right top-menu">
                       ...
                       <li class="dropdown">
                           ...
                           <ul class="dropdown-menu extended logout">
                               <li><a href="mis_datos.php"><i class="icon-user"></i> Mis Datos</a></li>
      ...
      <div id="main-content">
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Mis Datos</h4>
                            <div class="tools">
                        ...
                        <div class="widget-body form">
                            <!-- BEGIN FORM-->
                          <form action="graba_mis_datos.php" method="post" id="signupForm" class="cmxform form-horizontal" novalidate>
                          <input name="id_alumno" type="hidden" value="<?php echo $id_alumno;?>">
                                <div class="control-group ">
                                    <label class="control-label" for="nombre">Nombres</label>
                                    <div class="controls">
                                        <input type="text" name="nombre" id="nombre" class="span6 " value="<?php echo $nombre;?>">
                                    </div>
                                </div>
                                <div class="control-group ">
                                    <label class="control-label" for="apellido_P">Apellido Paterno</label>
                                    <div class="controls">
                                        <input type="text" name="apellido_P" id="apellido_P" class="span6 " value="<?php echo $apellido_P;?>">
                                    </div>
                                </div>
                                <div class="control-group ">
                                    <label class="control-label" for="Apellido_M">Apellido Materno</label>
                                    <div class="controls">
                                        <input type="text" name="apellido_M" id="apellido_M" class="span6 " value="<?php echo $apellido_M;?>">
                                    </div>
                                </div>
                                <div class="control-group ">
                                    <label class="control-label" for="fono">Fono</label>
                                    <div class="controls">
                                        <input type="text" name="fono" id="fono" class="span6 " value="<?php echo $fono;?>">
                                    </div>
                                </div>
                                <div class="control-group ">
                                    <label class="control-label" for="direccion">Email</label>
                                    <div class="controls">
                                        <input type="text" name="email" id="email" class="span6 " value="<?php echo $email;?>">
                                    </div>
                                </div>
                                 <div class="control-group ">
                                    <label class="control-label" for="emailInstitucional">Email Institucional</label>
                                    <div class="controls">
                                        <input name="emailInstitucional" type="text" class="span6 " id="emailInstitucional" value="<?php echo $emailInstitucional;?>" readonly>
                                    *Iniciar en <a href="http://www.gmail.com" target="_blank">Gmail.com</a> contraseña: la por defecto en el aula virtual</div>
                                </div>
                                <div class="control-group ">
                                    <label class="control-label" for="direccion">Direccion</label>
                                    <div class="controls">
                                        <input type="email" name="direccion" id="direccion" class="span6 " value="<?php echo $direccion;?>">
                                  </div>
                            </div>
                                 <div class="control-group ">
                                    <label class="control-label" for="direccion">Ciudad</label>
                                    <div class="controls">
                                        <input type="email" name="ciudad" id="ciudad" class="span6 " value="<?php echo $ciudad;?>">
                                   </div>
                            </div>
                            ...
                            if(isset($_GET["error"]))
							{
								...
								switch($error)
								{
									case"MD1":
										$msj_1="MSJ";
										$msj_2="Datos Modificados Correctamente :)";
										break;
									case"MD2":
										$msj_2="Falla al intentar Modificar.. :(";
										$msj_1="MSJ";
										break;
									case"MD3":
										$msj_1="MSJ";
										$msj_2="No se Puede Modificar...Verifiquen no existan campos vacios";
										break;
									default:		
										$msj_1="";
										$msj_2="";	
							...
							?>
                             <div class="control-group ">
                                    <label class="control-label" for="direccion"><?php echo $msj_1?></label>
                                     <div class="controls">
                                       <?php echo $msj_2;?>
                                   </div>
                ...
                <div class="widget-title">
                    <h4><i class="icon-reorder"></i>Mi Clave</h4>
                    <div class="tools">
                        <a class="collapse" href="javascript:;"></a>
                        <a class="config" data-toggle="modal" href="#portlet-config"></a>
                        <a class="reload" href="javascript:;"></a>
                ...
                <div class="widget-body form">
                    <!-- BEGIN FORM-->
                  <form action="graba_mi_clave.php" method="post" id="signupForm" class="cmxform form-horizontal" novalidate>
                  <input name="id_alumno" type="hidden" value="<?php echo $id_alumno;?>">
                        <div class="control-group ">
                            <label class="control-label" for="clave_actual">Clave Actual</label>
                            <div class="controls">
                                <input type="password" name="clave_actual" id="clave_actual" class="span6 " >
                            </div>
                        </div>
                        <div class="control-group ">
                            <label class="control-label" for="nueva_clave">Nueva Clave</label>
                            <div class="controls">
                                <input type="password" name="nueva_clave" id="nueva_clave" class="span6 " >
                            </div>
                        </div>
                        <div class="control-group ">
                            <label class="control-label" for="nueva_clave_2">Confirmar Nva Clave</label>
                            <div class="controls">
                                <input type="password" name="nueva_clave_2" id="nueva_clave_2" class="span6 ">
                            </div>
                        </div>
                    ...
                    if(isset($_GET["error"]))
                    {
                        ...
                        switch($error)
                        {
                            case"MC1":
                                $msj_1="MSJ";
                                $msj_2="No se puede Modificar... :(";
                                break;
                            case"MC2":
                                $msj_2="Clave Modificada Exitosamente.. :)";
                                $msj_1="MSJ";
                                break;
                            case"MC3":
                                $msj_1="MSJ";
                                $msj_2="Error al intentar Modificar, intentelo mas tarde...";
                                break;
							 case"MC4":
                                $msj_1="MSJ";
                                $msj_2="Las Claves Nuevas No coinciden, intentelo de nuevo";
                                break;
							case"MC5":
                                $msj_1="MSJ";
                                $msj_2="La Clave Actual No fue ingresada Correctamente, Vuelva a Intentar...";
                                break;	
                            default:		
                                $msj_1="";
                                $msj_2="";	
