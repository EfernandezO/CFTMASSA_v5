...
<form class="form-signin" action="solicitar_2.php" id="frm" method="post" role="form">
  ...
  <input type="email" id="inputEmail" name="email" class="form-control" placeholder="email" value="<?php echo $A_email;?>" required autofocus>
  <label for="inputText" class="sr-only">Fono contacto</label>
  <input type="text" id="inputText" name="fono" class="form-control" placeholder="telefono contacto" value="<?php echo $A_fono;?>" required>
  <label for="inputText" class="sr-only">Fono contacto</label>
  <input type="text" id="inputText2" name="fonoa" class="form-control" placeholder="telefono contacto 2" value="<?php echo $A_fonoa;?>" required>
