...
<form class="form-signin" action="llegada.php" id="frm" method="post" role="form">
  ...
  <input type="email" id="inputEmail" name="inputEmail" class="form-control" placeholder="email" value="<?php echo $A_email;?>" required autofocus>
  <label for="inputText" class="sr-only">Fono contacto</label>
  <input type="text" id="inputText" name="fonoContacto1" class="form-control" placeholder="telefono contacto" value="<?php echo $A_fono;?>" required>
  <label for="inputText" class="sr-only">Fono contacto</label>
  <input type="text" id="inputText2" name="fonoContacto2" class="form-control" placeholder="telefono contacto 2" value="<?php echo $A_fonoa;?>" required>
