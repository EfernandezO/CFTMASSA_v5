...
//--------------FIN CLASS_okalis---------------//
   ...
   //////////////////////XAJAX/////////////////
	...
	$xajax = new xajax("../../solicitudes/crea_solicitud/crea_solicitud_server.php");
 ...
 if(isset($_GET["error"]))
 {
	 ...
	 switch($error)
	 {
		 case"S0":
				...
				$img=$img_ok;
				$msjFinal='<div class="alert alert-info" role="alert">'.$img.' '.$msj.'</div>';
		 	break;
		 case"S1":
		 		$msj="No se puede Crear solicitud, ya existe una no autorizada...";
				$img=$img_error;
				$msjFinal='<div class="alert alert-danger" role="alert">'.$img.' '.$msj.'</div>';
		 	break;
		 case"S2":
		 		$msj="";
				$img=$img_error;
		...
		default:
			$msj="";	
			$img="";
			$msjFinal='<div class="alert alert-warning" role="alert">'.$img.' '.$msj.'</div>';
	 }
...
$num_solicitudes_no_autorizadas=0;
	...
	$cons="SELECT * FROM solicitudes WHERE tipo_receptor='alumno' AND id_receptor='$id_alumno' AND id_carrera_receptor='$id_carrera' AND tipo='certificado' ORDER by id Desc LIMIT 5";
		...
		if($num_solicitudes>0)
		{
			...
			while($S=$sql->fetch_assoc())
			{
				...
				$ARRAY_SOLICITUDES[$S_id]["tipo"]=$S_tipo;
	...
	if(count($ARRAY_SOLICITUDES)>0)
	{
		...
		{ 
			...
			$aux_tipo_solicitud=$valorS["tipo"];
		   ...
		   {
			   if($aux_autorizado=="no"){$clase_boton='btn btn-large btn-warning'; $jsBoton='';}
				else{$clase_boton='btn btn-large btn-success'; $jsBoton='onClick="ABRIR('.$nS.'); return false;"';}
			   
			   $solicitudesCertificados.='<button type="button" class="'.$clase_boton.'" '.$jsBoton.'>'.$aux_categoria.' ('.$aux_estado.')</button><br><br>';
		   }
		}
	}
	else
	{  $solicitudesCertificados.=' <button type="button" class="btn btn-large btn-error" >Sin Solicitudes</button>';}
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   <meta charset="utf-8">
   <title>Solicitudes Certificados</title>
...
function ABRIR(id){
	url='../../solicitudes/generacion_documentos/redireccion.php?id_solicitud='+id;
	<!--alert('Solicitud: '+id);-->
	window.location=url;
}
</script>
           ...
           <div class="container-fluid">
               ...
               <div class="top-nav ">
                   <ul class="nav pull-right top-menu">
                       ...
                       <li class="dropdown">
                           <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="background-color:#4a8bc2">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">Certificados</h3>
                   <ul class="breadcrumb">
                       <li>
                ...
                <div class="metro-nav">-->
                    ...
                    <div class="metro-nav-block nav-block-grey" >
                     ...
                     <div class="metro-nav-block nav-block-blue double" >
                        <a data-original-title="Certificados" href="certificadoAlumno1_v1.php">
                     ...
                     <div class="metro-nav-block nav-block-yellow">
                        <a data-original-title="Notas P" href="../tomaRamosAlumno/tomaRamosAlumno.php">
                            <i class="icon-edit-sign"></i>
               ...
               <div class="span12">
                  ...
                  <div class="widget red">
                        <div class="widget-title">
                           <h4>Estado de Solicitudes de Certificado</h4>
                           <span class="tools">
                        ...
                        Importante: las solicitudes verdes estan autorizadas y pueden ser descargadas, las naranjas aun no se autorizan.
                     <?php if($hayRespuesta){echo $msjFinal;}?>
                            <p>
                                <?php echo $solicitudesCertificados;?>
                            </p>
                        </div>
                  </div>
                  ...
                  <div class="widget green">
                        <div class="widget-title">
                           <h4>Crear Solicitud de Certificado</h4>
                           <span class="tools">
                               <a class="icon-chevron-down" href="javascript:;"></a>
                               <a class="icon-remove" href="javascript:;"></a>
                           </span>
                        ...
                        <div class="widget-body">
                          <p>
                                Informacion: 
                            Seccion en mantenimiento...</p>
                            <form action="../../solicitudes/crea_solicitud/crea_solicitud_2.php" method="post" enctype="multipart/form-data" class="cmxform form-horizontal" id="frm" novalidate>
                              <div class="control-group ">
                                <label class="control-label" for="nombre">Tipo</label>
                                    <div class="controls">
                                        <select class="custom-select d-block w-100" id="estadoFuas" required="" name="tipo">
              <option value="certificado">Certificado</option>
              
            </select>
            <input name="semestre" type="hidden" value="<?php echo $semestre_actual;?>">
            <input name="year" type="hidden" value="<?php echo $year_actual;?>">
            
                                </div>
                              </div>
                                <div class="control-group ">
                                    <label class="control-label" for="apellido_P">Certificado</label>
                                    <div class="controls">
                                        <select class="custom-select d-block w-100" id="estadoFuas" required="" name="categoria">
              <option value="alumno_regular">Alumno_regular</option>
              <option value="egreso">egreso</option>
              <option value="concentracion_notas">concentracion_notas</option>
              <option value="titulo_en_tramite">titulo_en_tramite</option>
            </select>
                                  </div>
                                </div>
                                <div class="control-group ">
                                    <label class="control-label" for="apellido_P">Comprobante tranferencia/deposito*</label>
                                    <div class="controls">
                               ...
                               <div class="control-group ">  
                                 <strong>Importante</strong><br /><ul>
  <li>Si desea un certificado, debe realizar una solicitud, esta debe ser autorizada para emitir el certificado</li>
  <li>Para autorizar una solicitud esta debe ser pagada, lo cual puede realizar directamente en nuestras oficinas o realizando transferencia o deposito en nuestra cuenta  del <strong>Banco Estado cta. cte: 438-7-016404-2</strong>. A nombre de CFT Massachusetts Ltda. Rut:76.155.424-7</li>
  <li>Si ud. realiza el dep&oacute;sito/tranferencia puede adjuntar el comprobante de pago para autorizar la solicitud en esta pagina o enviarlo por correo electronico a <strong>finanzas_talca@cftmass.cl</strong>. indicando sus datos</li>
  <li>Para cualquier consulta escribanos a info@cftmass.cl</li>
</ul>
                              </div>
                          
                            <div class="form-actions">
                                    <button type="button" class="btn btn-success" onclick="xajax_VERIFICA_SOLICITUD(xajax.getFormValues('frm')); return false;">Solicitar</button>
                              </div>
