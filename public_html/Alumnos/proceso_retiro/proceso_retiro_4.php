...
if(isset($_GET["error"]))
{
	...
	{
		case"RC0":
			$msj="Proceso de Retiro, Exitosamente Creado...";
			$actualizar_sesion=true;
			$img=$img_ok;
			break;
		case"RC1":
			$msj="Error al Crear Proceso de Retiro";
			$img=$img_error;
			break;	
		case"RA0":
			$msj="Proceso de Retiro, Exitosamente Actualizado...";
			$img=$img_ok;
			$actualizar_sesion=true;
			break;
		case"RA1":
			$msj="Error al Actualizar el Proceso de Retiro";
			$img=$img_error;
			break;		
...
{$_SESSION["SELECTOR_ALUMNO"]["situacion"]="R";}
?>
<body>
