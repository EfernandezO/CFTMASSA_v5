...
//-----------------------------------------//	
   ...
   //--------------------------------------------------//
	 ...
	 CAMBIA_ESTADO_CONEXION_ALUMNO($id_alumno, "ON");
	  $evento="Revisa Estado Financiero";
               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li class="active">Estado Financiero</li>
            ...
            <div class="row-fluid">
              ...
              <div class="widget orange">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i> Cuotas Registradas</h4>
                            <span class="tools">
                            ...
                            <div class="widget-body">
                                <table class="table table-striped table-bordered table-advance table-hover">
                                    <thead>
                                    <tr>
                                        <th><i class="icon-bullhorn"></i> Año</th>
                                        <th class="hidden-phone"><i class="icon-question-sign"></i> Valor</th>
                                        <th><i class="icon-bookmark"></i> Deuda</th>
                                        <th><i class=" icon-edit"></i> Vencimiento</th>
                                        <th>Condicion</th>
                                    </tr>
                                    </thead>
                                    <tbody>
									...
									require("../../../funciones/funciones_sistema.php");
                                     $consL="SELECT * FROM letras WHERE idalumn='$id_alumno' AND anulada='N' ORDER BY fechavenc";
									 //  echo"<b>$consL</b><br>";
										$sqlL=$conexion_mysqli->query($consL)or die($conexion_mysqli->error);
										$num_letra=$sqlL->num_rows;
										$deuda_actual=0;
										$aux=0;
										$suma_letra=0;
										$suma_letra_ad=0;	
									  ...
									  if($num_letra > 0)
									  {
										while($B=$sqlL->fetch_assoc())
										{
											...
											$suma_letra+=$valor;
											$suma_letra_ad+=$deudaXletra;	
											
											if($pagada=="S")
											{$condicion="Pagada"; $clase_x='label-success';}
											if($pagada=="N")
											{$condicion="Pendiente"; $clase_x='label-important';}
											if($pagada=="A")
											{$condicion="Abonada"; $clase_x='label-warning';}
											
											echo'<tr>
												<td><a href="#">'.$year.'</a></td>
												<td class="hidden-phone">'.$valor.'</td>
												<td>'.$deudaXletra.'</td>
												<td>'.$fechavenc.'</td>
									  ...
									  {
										 echo'<tr>
												<td colspan="5">Sin Cuotas Registradas</td>
											</tr>'; 
									  }
